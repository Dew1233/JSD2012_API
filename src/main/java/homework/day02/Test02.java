...
public class Test02 {
    public static void main(String[] args) {
        ...
        System.out.println("请求："+strs[0]);
        System.out.println("参数："+strs[1]);
        ...
        String str1 =  strs1[1].toString();
        System.out.println(str1);
        String [] strs2 = str1.split("&");
        for(int i = 0;i<strs2.length;i++){
            String [] strsmin = strs2[i].split("=");
            System.out.println("参数："+strsmin[0]+",参数值："+strsmin[1]);
