...
public class ParseXmlDemo {
    public static void main(String[] args) {
        ...
        3:通过Document对象获取根元素
        4:按照xml文档的结构从根元素开始逐渐获取子元素以达到解析目的
         */
        try{
            ...
            System.out.println("共有"+list.size()+"个emp标签");
...
//              //1获取<name>标签
                ...
                //获取age
                Element eageEle = empEle.element("age");
                int eage = Integer.parseInt(eageEle.getText());
                //获取gender
                /*Element egenderEle = empEle.element("gender");
                String egender = egenderEle.getText();*/
                String egender = empEle.elementText("gender");
                //获取<salary>
                Element esalaryEle = empEle.element("salary");
                int esalary = Integer.parseInt(esalaryEle.getText());
